...
import * as OBC from "@thatopen/components";
import { GeometryCullerRenderer, StreamPropertiesSettings, StreamLoaderSettings, StreamerDbCleaner } from "./src";
/**
 ...
 */
export declare class Highlighter extends OBC.Component implements OBC.Disposable, OBC.Configurable<HighlighterConfig> {
    /**
     * A unique identifier for the component.
     * This UUID is used to register the component within the Components system.
     */
     ...
     * @throws Will throw an error if the fragment does not belong to a FragmentsGroup.
     */
    highlightByID(name: string, fragmentIdMap: FragmentIdMap, removePrevious?: boolean, zoomToSelection?: boolean, exclude?: FragmentIdMap, fillMesh?: THREE.Mesh | undefined): Promise<void>;
    /**
 ...
 */
export declare class AreaMeasurement extends OBC.Component implements OBC.Createable, OBC.Disposable {
    /**
     * A unique identifier for the component.
     * This UUID is used to register the component within the Components system.
     */
...
export declare class GeometryCullerRenderer extends OBC.CullerRenderer {
    ...
    private _intervalID;
    private codes;
    constructor(components: OBC.Components, world: OBC.World, settings?: OBC.CullerRendererSettings);
    dispose(): void;
