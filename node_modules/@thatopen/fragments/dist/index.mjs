...
var $e = (a, t, s) => t in a ? je(a, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : a[t] = s;
var S = (a, t, s) => ($e(a, typeof t != "symbol" ? t + "" : t, s), s);
import * as L from "three";
import { BufferAttribute as Be, Vector3 as T, Vector2 as Xt, Plane as Te, Line3 as dt, Triangle as is, Sphere as He, Matrix4 as vt, Box3 as rt, BackSide as Xe, DoubleSide as Ye, FrontSide as ae, Mesh as Oe, Ray as Ze, BufferGeometry as fe } from "three";
class le extends L.InstancedMesh {
  /**
...
const Le = 0, Je = 1, We = 2, he = 2, Ls = 1.25, be = 1, vs = 6 * 4 + 4 + 4, Bs = 65535, Qe = Math.pow(2, -24), Ds = Symbol("SKIP_GENERATION");
function ti(a) {
...
function si(a, t = ArrayBuffer) {
  return a > 65535 ? new Uint32Array(new t(4 * a)) : new Uint16Array(new t(2 * a));
}
function ei(a, t) {
  if (!a.index) {
    const s = a.attributes.position.count, e = t.useSharedArrayBuffer ? SharedArrayBuffer : ArrayBuffer, i = si(s, e);
    a.setIndex(new Be(i, 1));
    for (let n = 0; n < s; n++)
      i[n] = n;
  }
}
...
function ii(a) {
  if (a.groups.length === 0)
    return !1;
  const t = Yt(a), s = Ue(a).sort((n, o) => n.offset - o.offset), e = s[s.length - 1];
...
function ri(a, t) {
  ...
  for (let b = 0; b < i; b++) {
    ...
    for (let d = 0; d < 3; d++) {
      ...
      I > A && (A = I), m > A && (A = m);
      const F = (A - g) / 2, x = d * 2;
      n[u + x + 0] = g + F, n[u + x + 1] = F + (Math.abs(g) + F) * Qe, g < t[d] && (t[d] = g), A > t[d + 3] && (t[d + 3] = A);
    }
  }
  return n;
}
const ft = 32, ci = (a, t) => a.candidate - t.candidate, gt = new Array(ft).fill().map(() => ({
  count: 0,
...
function ai(a, t, s, e, i, n) {
  let o = -1, r = 0;
  if (n === Le)
    o = ue(t), o !== -1 && (r = (t[o] + t[o + 3]) / 2);
  else if (n === Je)
    o = ue(a), o !== -1 && (r = fi(s, e, i, o));
  else if (n === We) {
    const c = Jt(a);
    let f = Ls * i;
    const l = e * 6, b = (e + i) * 6;
    for (let h = 0; h < 3; h++) {
      ...
      if (i < ft / 4) {
        ...
        const d = gt[ft - 1];
        de(d.bounds, d.rightCacheBounds);
        ...
        for (let I = 0; I < ft - 1; I++) {
          ...
          g !== 0 && (p === 0 ? de(A, fs) : _e(A, fs, fs)), p += g;
          let C = 0, v = 0;
          p !== 0 && (C = Jt(fs) / c);
          const M = i - p;
          M !== 0 && (v = Jt(x) / c);
          const V = be + Ls * (C * p + v * M);
...
function ui(a, t) {
  ...
  let b = !1;
  const h = new Float32Array(6), u = new Float32Array(6), _ = ri(s, h), w = t.indirect ? hi : li, y = [], d = t.indirect ? De(s) : Ue(s);
  if (d.length === 1) {
    const m = d[0], g = new ls();
    g.boundingData = h, oi(_, m.offset, m.count, u), I(g, m.offset, m.count, u), y.push(g);
  } else
    for (let m of d) {
      const g = new ls();
      g.boundingData = new Float32Array(6), Us(_, m.offset, m.count, g.boundingData, u), I(g, m.offset, m.count, u), y.push(g);
    }
  return y;
  function p(m) {
    c && c(m / f);
  ...
  function I(m, g, A, F = null, x = 0) {
    ...
    const C = ai(m.boundingData, F, _, g, A, r);
    if (C.axis === -1)
      return p(g + A), m.offset = g, m.count = A, m;
    ...
    if (v === g || v === g + A)
      ...
      m.left = M, M.boundingData = new Float32Array(6), Us(_, V, P, M.boundingData, u), I(M, V, P, u, x + 1);
      const B = new ls(), O = v, D = A - P;
      m.right = B, B.boundingData = new Float32Array(6), Us(_, O, D, B.boundingData, u), I(B, O, D, u, x + 1);
    }
    return m;
  }
}
function di(a, t) {
  const s = a.geometry;
  t.indirect && (a._indirectBuffer = bi(s, t.useSharedArrayBuffer), ii(s) && !t.verbose && console.warn(
    'MeshBVH: Provided geometry contains groups that do not fully span the vertex contents while using the "indirect" option. BVH may incorrectly report intersections on unrendered portions of the geometry.'
  )), a._indirectBuffer || ei(s, t);
  const e = ui(a, t);
  let i, n, o;
  ...
  function l(b, h) {
    ...
    if (w) {
      ...
      return n[u + 6] = d, o[_ + 14] = p, o[_ + 15] = Bs, b + vs;
    } else {
...
const _i = function() {
  ...
  const a = new T(), t = new T(), s = new Te(), e = new dt();
  return function(n, o) {
...
function zs(a) {
  return Math.abs(a) < mi;
}
class ot extends is {
  constructor(...t) {
    super(...t), this.isExtendedTriangle = !0, this.satAxes = new Array(4).fill().map(() => new T()), this.satBounds = new Array(4).fill().map(() => new _t()), this.points = [this.a, this.b, this.c], this.sphere = new He(), this.plane = new Te(), this.needsUpdate = !0;
  }
  intersectsSphere(t) {
    return pi(t, this);
  }
...
ot.prototype.closestPointToSegment = function() {
  ...
  return function(i, n = null, o = null) {
    ...
    for (let h = 0; h < 3; h++) {
      const u = (h + 1) % 3;
      s.start.copy(f[h]), s.end.copy(f[u]), oe(s, i, a, t), l = a.distanceToSquared(t), l < b && (b = l, n && n.copy(a), o && o.copy(t));
    }
...
ot.prototype.intersectsTriangle = function() {
  ...
  function _(w, y, d) {
    ...
    for (let g = 0; g < 3; g++) {
      ...
      if (!C && x && u.copy(A), (C || x) && !zs(u.distanceTo(F))) {
        if (I <= 1)
...
const R = new gi();
let At, Ht;
const zt = [], hs = /* @__PURE__ */ new re(() => new rt());
function Ii(a, t, s, e, i, n) {
  At = hs.getPrimitive(), Ht = hs.getPrimitive(), zt.push(At, Ht), R.setBuffer(a._roots[t]);
  const o = Xs(0, a.geometry, s, e, i, n);
  R.clearBuffer(), hs.releasePrimitive(At), hs.releasePrimitive(Ht), zt.pop(), zt.pop();
  const r = zt.length;
  return r > 0 && (Ht = zt[r - 1], At = zt[r - 2]), o;
}
function Xs(a, t, s, e, i = null, n = 0, o = 0) {
  const { float32Array: r, uint16Array: c, uint32Array: f } = R;
  let l = a * 2;
  if (Z(l, c)) {
    const h = J(a, f), u = tt(l, c);
    return G(a, r, At), e(h, u, !1, o, n + a, At);
  } else {
    let v = function(V) {
      const { uint16Array: P, uint32Array: B } = R;
      let O = V * 2;
      for (; !Z(O, P); )
        V = st(V), O = V * 2;
      return J(V, B);
    ...
    let _ = h, w = u, y, d, p, I;
    if (i && (p = At, I = Ht, G(_, r, p), G(w, r, I), y = i(p), d = i(I), d < y)) {
      _ = u, w = h;
      const V = y;
      y = d, d = V, p = I;
    }
...
const Wt = /* @__PURE__ */ new T(), Es = /* @__PURE__ */ new T();
function wi(a, t, s = {}, e = 0, i = 1 / 0) {
  const n = e * e, o = i * i;
  let r = 1 / 0, c = null;
  if (a.shapecast(
    {
      ...
      intersectsTriangle: (l, b) => {
        ...
        return h < r && (Es.copy(Wt), r = h, c = b), h < n;
      }
    }
  ), r === 1 / 0)
    return null;
...
const Et = /* @__PURE__ */ new T(), Rt = /* @__PURE__ */ new T(), Gt = /* @__PURE__ */ new T(), bs = /* @__PURE__ */ new Xt(), us = /* @__PURE__ */ new Xt(), ds = /* @__PURE__ */ new Xt(), pe = /* @__PURE__ */ new T(), me = /* @__PURE__ */ new T(), ye = /* @__PURE__ */ new T(), _s = /* @__PURE__ */ new T();
function xi(a, t, s, e, i, n) {
  let o;
  return n === Xe ? o = a.intersectTriangle(e, s, t, !0, i) : o = a.intersectTriangle(t, s, e, n !== Ye, i), o === null ? null : {
    distance: a.origin.distanceTo(i),
    point: i.clone()
  };
}
function Ai(a, t, s, e, i, n, o, r, c) {
  Et.fromBufferAttribute(t, n), Rt.fromBufferAttribute(t, o), Gt.fromBufferAttribute(t, r);
  const f = xi(a, Et, Rt, Gt, _s, c);
  if (f) {
    e && (bs.fromBufferAttribute(e, n), us.fromBufferAttribute(e, o), ds.fromBufferAttribute(e, r), f.uv = is.getInterpolation(_s, Et, Rt, Gt, bs, us, ds, new Xt())), i && (bs.fromBufferAttribute(i, n), us.fromBufferAttribute(i, o), ds.fromBufferAttribute(i, r), f.uv1 = is.getInterpolation(_s, Et, Rt, Gt, bs, us, ds, new Xt())), s && (pe.fromBufferAttribute(s, n), me.fromBufferAttribute(s, o), ye.fromBufferAttribute(s, r), f.normal = is.getInterpolation(_s, Et, Rt, Gt, pe, me, ye, new T()), f.normal.dot(a.direction) > 0 && f.normal.multiplyScalar(-1));
    const l = {
      a: n,
      b: o,
      c: r,
    ...
    is.getNormal(Et, Rt, Gt, l.normal), f.face = l, f.faceIndex = n;
  }
  return f;
}
function Ts(a, t, s, e, i) {
  const n = e * 3;
  let o = n + 0, r = n + 1, c = n + 2;
  const f = a.index;
  a.index && (o = f.getX(o), r = f.getX(r), c = f.getX(c));
  const { position: l, normal: b, uv: h, uv1: u } = a.attributes, _ = Ai(s, l, b, h, u, o, r, c, t);
...
function Vi(a, t, s, e, i) {
  ...
  for (let f = e, l = e + i; f < l; f++) {
    let b;
    b = Ts(n, t, s, f), b && b.distance < r && (c = b, r = b.distance);
  }
  return c;
}
function Fi(a, t, s, e, i, n, o) {
...
const ge = /* @__PURE__ */ new rt();
function Vt(a, t, s, e) {
  return G(a, t, ge), s.intersectBox(ge, e);
}
...
function Mi(a, t, s, e, i) {
  const { geometry: n, _indirectBuffer: o } = a;
  let r = 1 / 0, c = null;
  for (let f = e, l = e + i; f < l; f++) {
    let b;
    b = Ts(n, t, s, o ? o[f] : f), b && b.distance < r && (c = b, r = b.distance);
  }
  return c;
}
function Si(a, t, s, e, i, n, o) {
  const { geometry: r } = s, { index: c } = r, f = r.attributes.position;
  for (let l = a, b = t + a; l < b; l++) {
    let h;
...
const Ie = /* @__PURE__ */ new T();
function Bi(a, t, s, e, i) {
  R.setBuffer(a._roots[t]), Ys(0, a, s, e, i), R.clearBuffer();
}
function Ys(a, t, s, e, i) {
  const { float32Array: n, uint16Array: o, uint32Array: r } = R, c = a * 2;
  if (Z(c, o)) {
    const l = J(a, r), b = tt(c, o);
    vi(t, s, e, l, b, i);
  } else {
    const l = st(a);
    Vt(l, n, e, Ie) && Ys(l, t, s, e, i);
    const b = et(a, r);
    Vt(b, n, e, Ie) && Ys(b, t, s, e, i);
  }
}
const we = /* @__PURE__ */ new T(), Ti = ["x", "y", "z"];
function Oi(a, t, s, e) {
  R.setBuffer(a._roots[t]);
  const i = Zs(0, a, s, e);
  return R.clearBuffer(), i;
}
function Zs(a, t, s, e) {
  const { float32Array: i, uint16Array: n, uint32Array: o } = R;
  let r = a * 2;
  if (Z(r, n)) {
    const f = J(a, o), l = tt(r, n);
    return Vi(t, s, e, f, l);
  } else {
    const f = ze(a, o), l = Ti[f], h = e.direction[l] >= 0;
    let u, _;
    h ? (u = st(a), _ = et(a, o)) : (u = et(a, o), _ = st(a));
    const y = Vt(u, i, e, we) ? Zs(u, t, s, e) : null;
    if (y) {
      const I = y.point[l];
      if (h ? I <= i[_ + f] : (
        // min bounding data
    ...
    const p = Vt(_, i, e, we) ? Zs(_, t, s, e) : null;
    return y && p ? y.distance <= p.distance ? y : p : y || p || null;
  }
}
const ps = /* @__PURE__ */ new rt(), Nt = /* @__PURE__ */ new ot(), kt = /* @__PURE__ */ new ot(), Qt = /* @__PURE__ */ new vt(), xe = /* @__PURE__ */ new H(), ms = /* @__PURE__ */ new H();
function Li(a, t, s, e) {
  R.setBuffer(a._roots[t]);
  const i = Js(0, a, s, e);
  return R.clearBuffer(), i;
...
function Js(a, t, s, e, i = null) {
  const { float32Array: n, uint16Array: o, uint32Array: r } = R;
  let c = a * 2;
  if (i === null && (s.boundingBox || s.computeBoundingBox(), xe.set(s.boundingBox.min, s.boundingBox.max, e), i = xe), Z(c, o)) {
    ...
    if (Qt.copy(e).invert(), s.boundsTree)
      return G(a, n, ms), ms.matrix.copy(Qt), ms.needsUpdate = !0, s.boundsTree.shapecast({
    ...
    const l = a + 8, b = r[a + 6];
    return G(l, n, ps), !!(i.intersectsBox(ps) && Js(l, t, s, e, i) || (G(b, n, ps), i.intersectsBox(ps) && Js(b, t, s, e, i)));
  }
}
const ys = /* @__PURE__ */ new vt(), Rs = /* @__PURE__ */ new H(), ts = /* @__PURE__ */ new H(), Di = /* @__PURE__ */ new T(), Ui = /* @__PURE__ */ new T(), zi = /* @__PURE__ */ new T(), Ei = /* @__PURE__ */ new T();
...
const Ae = /* @__PURE__ */ new T();
function Ni(a, t, s, e, i) {
  R.setBuffer(a._roots[t]), Ws(0, a, s, e, i), R.clearBuffer();
}
function Ws(a, t, s, e, i) {
  ...
  if (Z(c, o)) {
    ...
    const l = st(a);
    Vt(l, n, e, Ae) && Ws(l, t, s, e, i);
    const b = et(a, r);
    Vt(b, n, e, Ae) && Ws(b, t, s, e, i);
  }
}
const ve = /* @__PURE__ */ new T(), ki = ["x", "y", "z"];
function qi(a, t, s, e) {
  R.setBuffer(a._roots[t]);
  const i = Qs(0, a, s, e);
  return R.clearBuffer(), i;
...
function Qs(a, t, s, e) {
  ...
  if (Z(r, n)) {
    ...
    const f = ze(a, o), l = ki[f], h = e.direction[l] >= 0;
    let u, _;
    h ? (u = st(a), _ = et(a, o)) : (u = et(a, o), _ = st(a));
    const y = Vt(u, i, e, ve) ? Qs(u, t, s, e) : null;
    if (y) {
      const I = y.point[l];
      if (h ? I <= i[_ + f] : (
        // min bounding data
    ...
    const p = Vt(_, i, e, ve) ? Qs(_, t, s, e) : null;
    return y && p ? y.distance <= p.distance ? y : p : y || p || null;
  }
}
const gs = /* @__PURE__ */ new rt(), qt = /* @__PURE__ */ new ot(), Kt = /* @__PURE__ */ new ot(), ss = /* @__PURE__ */ new vt(), Ve = /* @__PURE__ */ new H(), Is = /* @__PURE__ */ new H();
function Ki(a, t, s, e) {
  R.setBuffer(a._roots[t]);
  const i = te(0, a, s, e);
  return R.clearBuffer(), i;
...
function te(a, t, s, e, i = null) {
  const { float32Array: n, uint16Array: o, uint32Array: r } = R;
  let c = a * 2;
  if (i === null && (s.boundingBox || s.computeBoundingBox(), Ve.set(s.boundingBox.min, s.boundingBox.max, e), i = Ve), Z(c, o)) {
    const l = t.geometry, b = l.index, h = l.attributes.position, u = s.index, _ = s.attributes.position, w = J(a, r), y = tt(c, o);
    if (ss.copy(e).invert(), s.boundsTree)
      return G(a, n, Is), Is.matrix.copy(ss), Is.needsUpdate = !0, s.boundsTree.shapecast({
    ...
    const l = a + 8, b = r[a + 6];
    return G(l, n, gs), !!(i.intersectsBox(gs) && te(l, t, s, e, i) || (G(b, n, gs), i.intersectsBox(gs) && te(b, t, s, e, i)));
  }
}
const ws = /* @__PURE__ */ new vt(), Gs = /* @__PURE__ */ new H(), es = /* @__PURE__ */ new H(), ji = /* @__PURE__ */ new T(), $i = /* @__PURE__ */ new T(), Hi = /* @__PURE__ */ new T(), Xi = /* @__PURE__ */ new T();
function Yi(a, t, s, e = {}, i = {}, n = 0, o = 1 / 0) {
  t.boundingBox || t.computeBoundingBox(), Gs.set(t.boundingBox.min, t.boundingBox.max, s), Gs.needsUpdate = !0;
  const r = a.geometry, c = r.attributes.position, f = r.index, l = t.attributes.position, b = t.index, h = Q.getPrimitive(), u = Q.getPrimitive();
  let _ = ji, w = $i, y = null, d = null;
  i && (y = Hi, d = Xi);
  let p = 1 / 0, I = null, m = null;
...
const ns = new R.constructor(), Cs = new R.constructor(), It = new re(() => new rt()), jt = new rt(), $t = new rt(), Ns = new rt(), ks = new rt();
let qs = !1;
function Ji(a, t, s, e) {
  if (qs)
  ...
  for (let l = 0, b = i.length; l < b; l++) {
    ...
    G(0, ns.float32Array, h), h.applyMatrix4(f);
...
function it(a, t, s, e, i, n = 0, o = 0, r = 0, c = 0, f = null, l = !1) {
  ...
  if (A && g)
    ...
    G(x, y, Ns), G(C, y, ks);
    const v = f.intersectsBox(Ns), M = f.intersectsBox(ks);
    if (v && M)
      F = it(
        a,
        x,
...
const xs = /* @__PURE__ */ new H(), Fe = /* @__PURE__ */ new rt();
class ce {
  ...
  static deserialize(t, s, e = {}) {
    ...
    const { index: i, roots: n, indirectBuffer: o } = t, r = new ce(s, { ...e, [Ds]: !0 });
    if (r._roots = n, r._indirectBuffer = o || null, e.setIndex) {
      const c = s.getIndex();
      if (c === null) {
        const f = new Be(t.index, 1, !1);
        s.setIndex(f);
      } else
  ...
  constructor(t, s = {}) {
    ...
    if (s = Object.assign({
      ...
      [Ds]: !1
    }, s), s.useSharedArrayBuffer && !Zi())
      throw new Error("MeshBVH: SharedArrayBuffer is not available.");
    this.geometry = t, this._roots = null, this._indirectBuffer = null, s[Ds] || (di(this, s), !t.boundingBox && s.setBoundingBox && (t.boundingBox = this.getBoundingBox(new rt())));
    const { _indirectBuffer: e } = this;
    this.resolveTriangleIndex = s.indirect ? (i) => e[i] : (i) => i;
  }
  refit(t = null) {
    return (this.indirect ? Gi : Ci)(this, t);
  }
  traverse(t, s = 0) {
    const e = this._roots[s], i = new Uint32Array(e), n = new Uint16Array(e);
    o(0);
    function o(r, c = 0) {
      const f = r * 2, l = n[f + 15] === Bs;
      if (l) {
  ...
  /* Core Cast Functions */
  raycast(t, s = ae) {
    const e = this._roots, i = this.geometry, n = [], o = s.isMaterial, r = Array.isArray(s), c = i.groups, f = o ? s.side : s, l = this.indirect ? Ni : Bi;
  ...
  raycastFirst(t, s = ae) {
    ...
    let r = null;
    const c = i.groups, f = n ? s.side : s, l = this.indirect ? qi : Oi;
    for (let b = 0, h = e.length; b < h; b++) {
  ...
  intersectsGeometry(t, s) {
    let e = !1;
    const i = this._roots, n = this.indirect ? Ki : Li;
    for (let o = 0, r = i.length; o < r && (e = n(this, o, t, s), !e); o++)
      ;
    return e;
  }
  shapecast(t) {
    const s = Q.getPrimitive(), e = this.indirect ? Si : Fi;
    let {
  ...
  getBoundingBox(t) {
    return t.makeEmpty(), this._roots.forEach((e) => {
      G(0, new Float32Array(e), Fe), t.union(Fe);
    }), t;
  }
}
function Ce(a, t, s) {
...
const Ks = /* @__PURE__ */ new Ze(), Pe = /* @__PURE__ */ new vt(), Wi = Oe.prototype.raycast;
function Qi(a, t) {
  if (this.geometry.boundsTree) {
    if (this.material === void 0)
      return;
    Pe.copy(this.matrixWorld).invert(), Ks.copy(a.ray).applyMatrix4(Pe);
...
const os = class os {
   ...
   */
  static apply(t) {
    os.initialized || (fe.prototype.computeBoundsTree = tn, fe.prototype.disposeBoundsTree = sn, Oe.prototype.raycast = Qi, os.initialized = !0), t.boundsTree || t.computeBoundsTree();
  }
  /**
...
const js = 2, at = 4, ut = 4, W = 4, wt = new Int32Array(2), Me = new Float32Array(wt.buffer), Se = new Float64Array(wt.buffer), As = new Uint16Array(new Uint8Array([1, 0]).buffer)[0] === 1;
var se;
(function(a) {
...
class Dt {
  ...
  readFloat32(t) {
    return wt[0] = this.readInt32(t), Me[0];
  }
  readFloat64(t) {
    return wt[As ? 0 : 1] = this.readInt32(t), wt[As ? 1 : 0] = this.readInt32(t + 4), Se[0];
  }
  writeInt8(t, s) {
    this.bytes_[t] = s;
  }
  ...
  writeFloat32(t, s) {
    Me[0] = s, this.writeInt32(t, wt[0]);
  }
  writeFloat64(t, s) {
    Se[0] = s, this.writeInt32(t, wt[As ? 0 : 1]), this.writeInt32(t + 4, wt[As ? 1 : 0]);
  }
  /**
...
let Vs = class Tt {
  ...
  static getSizePrefixedRootAsFragmentsGroup(t, s) {
    return t.setPosition(t.position() + W), (s || new ie()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
...
class en {
  ...
  import(t) {
    const s = new Dt(t), e = $s.getRootAsFragmentsGroup(s), i = this.constructFragmentGroup(e), n = e.itemsLength();
    for (let o = 0; o < n; o++) {
      const r = e.items(o);
      if (!r)
        continue;
   ...
   */
  export(t) {
    const s = new rs(1024), e = [], i = $s, n = ee;
    let o = null;
    if (t.civilData) {
      const q = [], E = Re, z = Ge;
    ...
    const Os = $s.endFragmentsGroup(s);
    return s.finish(Os), s.asUint8Array();
  }
  setID(t, s) {
    const e = t.id();
  ...
  constructFragmentGroup(t) {
    ...
    if (e) {
      ...
      for (let M = 0; M < v; M++) {
        const V = new L.LineBasicMaterial({ color: 16777215 }), P = new ke(), B = e.alignments(M);
        if (!B)
...
let Hs = class ne {
  ...
  static getSizePrefixedRootAsFragmentsGroup(t, s) {
    return t.setPosition(t.position() + W), (s || new ne()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
...
class nn {
  ...
  /** {@link FragmentParser.import} */
  import(t) {
    const s = new Dt(t), e = Hs.getRootAsFragmentsGroup(s), i = this.constructFragmentGroup(e), n = e.itemsLength();
    for (let o = 0; o < n; o++) {
      const r = e.items(o);
      if (!r)
        continue;
   ...
   */
  export(t) {
    const s = new rs(1024), e = [], i = Hs, n = N;
    let o = null;
    if (t.civilData) {
      const z = [], U = Ne, j = bt;
    ...
    const A = s.createString(t.uuid), F = s.createString(t.name), x = s.createString(t.ifcMetadata.name), C = s.createString(t.ifcMetadata.description), v = s.createString(t.ifcMetadata.schema), M = i.createItemsKeysIndicesVector(s, u), V = i.createItemsKeysVector(s, _), P = i.createItemsRelsIndicesVector(s, w), B = i.createItemsRelsVector(s, y), O = i.createIdsVector(s, d), D = i.createOpaqueGeometriesIdsVector(s, m), $ = i.createTransparentGeometriesIdsVector(
      s,
      g
    ), { min: X, max: Y } = t.boundingBox, Os = [X.x, X.y, X.z, Y.x, Y.y, Y.z], q = i.createBoundingBoxVector(s, Os);
  ...
  constructFragmentGroup(t) {
    ...
    if (e) {
      ...
      const V = e.alignmentsLength();
      for (let P = 0; P < V; P++) {
        const B = new L.LineBasicMaterial({ color: 16777215 }), O = new ke(), D = e.alignments(P);
        if (!D)
          throw new Error("Alignment not found!");
...
const Ss = class Ss extends L.Group {
  constructor() {
    super(...arguments);
    /**
...
class qe extends L.LineSegments {
  /**
...
export {
  ...
  Ee as Fragment,
  le as FragmentMesh,
  Ms as FragmentsGroup,
  fn as Serializer,
  ln as StreamSerializer
};
