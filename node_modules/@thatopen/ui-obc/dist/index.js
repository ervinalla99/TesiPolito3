import * as P from "@thatopen/components";
import * as B from "web-ifc";
import * as N from "@thatopen/components-front";
import * as I from "three";
import { Object3D as uo, Vector2 as ho, Vector3 as nn, Matrix4 as xs } from "three";
var po = Object.defineProperty, fo = (i, t, e) => t in i ? po(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e, Ot = (i, t, e) => (fo(i, typeof t != "symbol" ? t + "" : t, e), e);
const qt = Math.min, rt = Math.max, ti = Math.round, vt = (i) => ({
  x: i,
  y: i
}), mo = {
  left: "right",
...
const wo = async (i, t, e) => {
  ...
  for (let x = 0; x < a.length; x++) {
    ...
    }, $ && v <= 50 && (v++, typeof $ == "object" && ($.placement && (c = $.placement), $.rects && (u = $.rects === !0 ? await o.getElementRects({
      reference: i,
      floating: t,
      strategy: n
    }) : $.rects), {
          ...
          switch (p) {
            case "bestFit": {
              ...
              const K = (ht = O.filter((q) => {
                ...
                return !0;
              }).map((q) => [q.placement, q.overflows.filter((et) => et > 0).reduce((et, Ei) => et + Ei, 0)]).sort((q, et) => q[1] - et[1])[0]) == null ? void 0 : ht[0];
              K && (H = K);
              break;
            }
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      ...
      function v() {
        ...
        if (d.length >= 2) {
          if (Mt(e) === "y") {
            const O = d[0], Q = d[d.length - 1], kt = at(e) === "top", ht = O.top, U = Q.bottom, dt = kt ? O.left : Q.left, H = kt ? O.right : Q.right, K = H - dt, q = U - ht;
            return {
              top: ht,
              bottom: U,
              left: dt,
...
function En(i) {
  return typeof ShadowRoot > "u" ? !1 : i instanceof ShadowRoot || i instanceof V(i).ShadowRoot;
}
function Re(i) {
  const {
    overflow: t,
...
function Po(i, t, e) {
  return t === void 0 && (t = !1), !e || t && e !== V(i) ? !1 : t;
}
function we(i, t, e, s) {
...
function No(i) {
  ...
  const r = n === "fixed", o = wt(s), a = t ? Rs(t.floating) : !1;
  if (s === o || a && r)
    return e;
  let l = {
    scrollLeft: 0,
...
function Do(i, t) {
  const e = we(i, !0, t === "fixed"), s = e.top + i.clientTop, n = e.left + i.clientLeft, r = it(i) ? Vt(i) : vt(1), o = i.clientWidth * r.x, a = i.clientHeight * r.y, l = n * r.x, u = s * r.y;
  return {
    width: o,
    height: a,
    x: l,
...
function Ms(i, t) {
  const e = Xt(i);
  return e === t || !lt(e) || pi(e) ? !1 : X(e).position === "fixed" || Ms(e, t);
}
function jo(i, t) {
  const e = t.get(i);
  if (e)
    return e;
  let s = Fi(i, [], !1).filter((a) => lt(a) && yt(a) !== "body"), n = null;
...
function Bo(i, t, e) {
  const s = it(t), n = wt(t), r = e === "fixed", o = we(i, !0, r, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
 ...
 */
const Je = globalThis, an = Je.ShadowRoot && (Je.ShadyCSS === void 0 || Je.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ln = Symbol(), kn = /* @__PURE__ */ new WeakMap();
let Fs = class {
  constructor(i, t, e) {
    if (this._$cssResult$ = !0, e !== ln)
...
const Go = (i) => new Fs(typeof i == "string" ? i : i + "", void 0, ln), T = (i, ...t) => {
...
}, On = an ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Yo, defineProperty: Xo, getOwnPropertyDescriptor: Jo, getOwnPropertyNames: Qo, getOwnPropertySymbols: Ko, getPrototypeOf: Zo } = Object, Jt = globalThis, Tn = Jt.trustedTypes, ta = Tn ? Tn.emptyScript : "", In = Jt.reactiveElementPolyfillSupport, be = (i, t) => i, ii = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? ta : null;
      break;
  ...
  return e;
} }, cn = (i, t) => !Yo(i, t), Pn = { attribute: !0, type: String, converter: ii, reflect: !1, hasChanged: cn };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ni = globalThis, si = ni.trustedTypes, Rn = si ? si.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Bs = "$lit$", mt = `lit$${Math.random().toFixed(9).slice(2)}$`, Us = "?" + mt, ea = `<${Us}>`, Lt = document, $e = () => Lt.createComment(""), Ce = (i) => i === null || typeof i != "object" && typeof i != "function", Vs = Array.isArray, ia = (i) => Vs(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Ti = `[ 	
\f\r]`, pe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Nn = /-->/g, Mn = />/g, Tt = RegExp(`>|${Ti}(?:([^\\s"'>=/]+)(${Ti}*=${Ti}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ln = /'/g, zn = /"/g, Ws = /^(?:script|style|textarea|title)$/i, na = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), y = na(1), Qt = Symbol.for("lit-noChange"), M = Symbol.for("lit-nothing"), Dn = /* @__PURE__ */ new WeakMap(), Pt = Lt.createTreeWalker(Lt, 129);
function Gs(i, t) {
...
const sa = (i, t) => {
  ...
  let n, r = t === 2 ? "<svg>" : "", o = pe;
  for (let a = 0; a < e; a++) {
    const l = i[a];
    let u, h, d = -1, c = 0;
    for (; c < l.length && (o.lastIndex = c, h = o.exec(l), h !== null); )
      c = o.lastIndex, o === pe ? h[1] === "!--" ? o = Nn : h[1] !== void 0 ? o = Mn : h[2] !== void 0 ? (Ws.test(h[2]) && (n = RegExp("</" + h[2], "g")), o = Tt) : h[3] !== void 0 && (o = Tt) : o === Tt ? h[0] === ">" ? (o = n ?? pe, d = -1) : h[1] === void 0 ? d = -2 : (d = o.lastIndex - h[2].length, u = h[1], o = h[3] === void 0 ? Tt : h[3] === '"' ? zn : Ln) : o === zn || o === Ln ? o = Tt : o === Nn || o === Mn ? o = pe : (o = Tt, n = void 0);
    const p = o === Tt && i[a + 1].startsWith("/>") ? " " : "";
    r += o === pe ? l + ea : d >= 0 ? (s.push(u), l.slice(0, d) + Bs + l.slice(d) + mt + p) : l + mt + (d === -2 ? a : p);
  }
...
class Ee {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = Ee.createElement(u, s), Pt.currentNode = this.el.content, e === 2) {
        ...
        if (n.hasAttributes())
          for (const d of n.getAttributeNames())
            if (d.endsWith(Bs)) {
              ...
              l.push({ type: 1, index: r, name: v[2], strings: p, ctor: v[1] === "." ? oa : v[1] === "?" ? aa : v[1] === "@" ? la : mi }), n.removeAttribute(d);
            } else
...
function Kt(i, t, e = i, s) {
  ...
  return (o == null ? void 0 : o.constructor) !== a && ((r = o == null ? void 0 : o._$AO) == null || r.call(o, !1), a === void 0 ? o = void 0 : (o = new a(i), o._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = o : e._$Cl = o), o !== void 0 && (t = Kt(i, o._$AS(i, t.values), o, s)), t;
}
class ra {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: s } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? Lt).importNode(e, !0);
    Pt.currentNode = n;
...
class Ne {
  ...
  _$AI(t, e = this) {
    t = Kt(this, t, e), Ce(t) ? t === M || t == null || t === "" ? (this._$AH !== M && this._$AR(), this._$AH = M) : t !== this._$AH && t !== Qt && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ia(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  k(t) {
    ...
    let s, n = 0;
    for (const r of t)
      n === e.length ? e.push(s = new Ne(this.S($e()), this.S($e()), this, this.options)) : s = e[n], s._$AI(r), n++;
...
const jn = ni.litHtmlPolyfillSupport;
...
var Hn;
k._$litElement$ = !0, k.finalized = !0, (Hn = globalThis.litElementHydrateSupport) == null || Hn.call(globalThis, { LitElement: k });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ua = { attribute: !0, type: String, converter: ii, reflect: !1, hasChanged: cn }, ha = (i = ua, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const da = (i) => i.strings === void 0;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const pa = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, fa = (i) => (...t) => ({ _$litDirective$: i, values: t });
let ma = class {
  constructor(i) {
  }
  get _$AU() {
...
const ge = (i, t) => {
  ...
  if (s === void 0)
    return !1;
  for (const n of s)
    (e = n._$AO) == null || e.call(n, t, !1), ge(n, t);
  return !0;
}, ri = (i) => {
  let t, e;
  do {
...
const Ii = /* @__PURE__ */ new WeakMap(), ot = fa(class extends ya {
  render(i) {
    return M;
  }
  update(i, [t]) {
...
const ve = /^[a-z0-9]+(-[a-z0-9]+)*$/, ze = (i, t, e, s = "") => {
  const n = i.split(":");
  if (i.slice(0, 1) === "@") {
  ...
  return null;
}, Qe = (i, t) => i ? !!((i.provider === "" || i.provider.match(ve)) && (t && i.prefix === "" || i.prefix.match(ve)) && i.name.match(ve)) : !1;
function Aa(i, t) {
  const e = {};
...
function Se(i) {
  const t = typeof i == "string" ? ze(i, !0, Ae) : i;
  if (t) {
...
const bi = /* @__PURE__ */ Object.create(null), qe = [
...
const Xn = "iconify2", ke = "iconify", sr = ke + "-count", Jn = ke + "-version", rr = 36e5, Ua = 168, Va = 50;
function Gi(i, t) {
  try {
    return i.getItem(t);
  } catch {
...
}, Ja = (i) => new Promise((t, e) => {
  const s = typeof i == "string" ? ze(i, !0) : i;
  if (!s) {
    e(i);
    return;
  }
...
function Ka(i, t) {
  const e = typeof i == "string" ? ze(i, !0, !0) : null;
  if (!e) {
    const r = Qa(i);
    return {
      value: i,
...
const tl = /(-?[0-9.]*[0-9]+[0-9.]*)/g, el = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function Xi(i, t, e) {
  if (t === 1)
    return i;
...
function fr() {
  ...
  return {
    enableCache: (t) => Zn(t, !0),
    disableCache: (t) => Zn(t, !1),
    iconLoaded: Wn,
    iconExists: Wn,
    getIcon: Ra,
    listIcons: Pa,
...
function wl(i = "iconify-icon") {
  ...
  const n = [
     ...
     */
    constructor() {
      super(), Ot(this, "_shadowRoot"), Ot(this, "_initialised", !1), Ot(this, "_state"), Ot(this, "_checkQueued", !1), Ot(this, "_connected", !1), Ot(this, "_observer", null), Ot(this, "_visible", !0);
    ...
    */
    ...
    _check() {
      ...
      if (!a.rendered || !this._visible)
        return;
      const u = this.getAttribute("mode"), h = Bn(this);
     ...
     */
    _gotIconData(a) {
      this._checkQueued = !1, this._renderIcon(a, Bn(this), this.getAttribute("mode"));
    }
    /**
...
wl() || fr();
var $l = Object.defineProperty, nt = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && $l(t, e, n), n;
}, Xe;
const tt = (Xe = class extends k {
  constructor() {
    super(), this.labelHidden = !1, this.active = !1, this.disabled = !1, this.vertical = !1, this.tooltipVisible = !1, this._parent = Wt(), this._tooltip = Wt(), this._contextMenu = Wt(), this._mouseLeave = !1, this.onWindowMouseUp = (i) => {
      const { value: t } = this._contextMenu;
      !this.contains(i.target) && t && (t.visible = !1);
    }, this.mouseLeave = !0, this.addEventListener("click", (i) => i.stopPropagation());
  }
  set mouseLeave(i) {
...
nt([
  m({ type: Boolean, attribute: "label-hidden", reflect: !0 })
], tt.prototype, "labelHidden");
nt([
  m({ type: Boolean, reflect: !0 })
], tt.prototype, "active");
nt([
  m({ type: Boolean, reflect: !0, attribute: "disabled" })
...
nt([
  m({ type: Number, attribute: "tooltip-time", reflect: !0 })
], tt.prototype, "tooltipTime");
nt([
  m({ type: Boolean, attribute: "tooltip-visible", reflect: !0 })
], tt.prototype, "tooltipVisible");
nt([
  m({ type: String, attribute: "tooltip-title", reflect: !0 })
], tt.prototype, "tooltipTitle");
nt([
  m({ type: String, attribute: "tooltip-text", reflect: !0 })
], tt.prototype, "tooltipText");
let Cl = tt;
var El = Object.defineProperty, De = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && El(t, e, n), n;
};
const br = class extends k {
  constructor() {
...
var Al = Object.defineProperty, ne = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Al(t, e, n), n;
};
const gr = class extends k {
  constructor() {
    super(...arguments), this.vertical = !1, this.color = "#bcf124", this._colorInput = Wt(), this._textInput = Wt(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
      const e = t.target;
...
var Ol = Object.defineProperty, Tl = Object.getOwnPropertyDescriptor, Il = (i, t, e, s) => {
  for (var n = Tl(t, e), r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Ol(t, e, n), n;
};
const vr = class extends k {
  constructor() {
...
const ci = (i, t = !0) => {
  ...
  return e;
}, vi = (i) => i === "true" || i === "false" ? i === "true" : i && !isNaN(Number(i)) && i.trim() !== "" ? Number(i) : i, Pl = [">=", "<=", "=", ">", "<", "?", "/", "#"];
function os(i) {
  const t = Pl.find(
...
var Rl = Object.defineProperty, Nl = Object.getOwnPropertyDescriptor, Ct = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? Nl(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && Rl(t, e, n), n;
};
const _r = class extends k {
  constructor() {
...
Ct([
  m({ type: Boolean, attribute: "no-mark", reflect: !0 })
...
var Ml = Object.defineProperty, Ll = Object.getOwnPropertyDescriptor, Et = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? Ll(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && Ml(t, e, n), n;
};
const xr = class extends $t {
  constructor() {
    super(), this.multiple = !1, this.required = !1, this.vertical = !1, this._visible = !1, this._value = /* @__PURE__ */ new Set(), this.onValueChange = new Event("change"), this.onWindowMouseUp = (t) => {
  ...
  findOption(t) {
    return this._options.find((e) => e instanceof D ? e.label === t || e.value === t : !1);
  }
  connectedCallback() {
    super.connectedCallback(), window.addEventListener("mouseup", this.onWindowMouseUp);
  }
...
var zl = Object.defineProperty, wr = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && zl(t, e, n), n;
};
const $r = class extends k {
  constructor() {
...
let Dl = Zi;
var jl = Object.defineProperty, yi = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && jl(t, e, n), n;
};
...
var Hl = Object.defineProperty, He = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Hl(t, e, n), n;
};
const Er = class extends k {
  constructor() {
...
He([
  m({ type: Boolean, attribute: "icon-hidden", reflect: !0 })
], se.prototype, "iconHidden");
He([
  m({ type: Boolean, reflect: !0 })
], se.prototype, "vertical");
var Fl = Object.defineProperty, Bl = Object.getOwnPropertyDescriptor, J = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? Bl(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && Fl(t, e, n), n;
};
const Ar = class extends k {
  constructor() {
    super(...arguments), this._value = 0, this.vertical = !1, this.slider = !1, this._input = Wt(), this.onValueChange = new Event("change");
  }
  set value(t) {
...
var Ul = Object.defineProperty, Vl = Object.getOwnPropertyDescriptor, Fe = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? Vl(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && Ul(t, e, n), n;
};
const Sr = class extends k {
  constructor() {
...
Fe([
  m({ type: Boolean, attribute: "header-hidden", reflect: !0 })
], re.prototype, "headerHidden", 2);
var Wl = Object.defineProperty, Be = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Wl(t, e, n), n;
};
const kr = class extends k {
  constructor() {
...
var Gl = Object.defineProperty, Ue = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Gl(t, e, n), n;
};
const Or = class extends k {
  constructor() {
  ...
  onSlotChange(t) {
    const e = t.target.assignedElements();
    for (const s of e)
      s instanceof D && (s.noMark = !0, s.removeEventListener("click", this.onOptionClick), s.addEventListener("click", this.onOptionClick));
  }
  findOption(t) {
    return this._options.find((e) => e instanceof D ? e.label === t || e.value === t : !1);
  }
...
var ql = Object.defineProperty, Yl = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && ql(t, e, n), n;
};
const Tr = class extends k {
  constructor() {
...
var Xl = Object.defineProperty, Jl = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Xl(t, e, n), n;
};
const Pr = class extends k {
  constructor() {
...
var Ql = Object.defineProperty, Kl = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Ql(t, e, n), n;
};
const Nr = class extends k {
  constructor() {
...
let Mr = Nr;
Kl([
  m({ type: Boolean, attribute: "children-hidden", reflect: !0 })
], Mr.prototype, "childrenHidden");
var Zl = Object.defineProperty, Ve = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Zl(t, e, n), n;
};
const Lr = class extends k {
  constructor() {
...
Ve([
  m({ type: Boolean, attribute: "is-header", reflect: !0 })
], le.prototype, "isHeader");
Ve([
  Me()
], le.prototype, "_intersecting");
var tc = Object.defineProperty, ec = Object.getOwnPropertyDescriptor, ce = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? ec(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && tc(t, e, n), n;
};
const zr = class extends k {
  constructor() {
...
ce([
  m({ type: String, attribute: "min-col-width", reflect: !0 })
...
var ic = Object.defineProperty, nc = Object.getOwnPropertyDescriptor, _i = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? nc(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && ic(t, e, n), n;
};
const Dr = class extends k {
  constructor() {
...
var sc = Object.defineProperty, rc = Object.getOwnPropertyDescriptor, ue = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? rc(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && sc(t, e, n), n;
};
const jr = class extends k {
  constructor() {
  ...
  onSlotChange(t) {
    ...
    const e = t.target.assignedElements(), s = e.find((n) => n instanceof Y ? this.tab ? n.name === this.tab : !n.hidden : !1);
...
ue([
  m({ type: Boolean, attribute: "switchers-hidden", reflect: !0 })
...
ue([
  m({ type: Boolean, attribute: "switchers-full", reflect: !0 })
 ...
 */
const oc = (i) => i ?? M;
var ac = Object.defineProperty, lc = Object.getOwnPropertyDescriptor, At = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? lc(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && ac(t, e, n), n;
};
const Hr = class extends k {
  constructor() {
...
var cc = Object.defineProperty, uc = Object.getOwnPropertyDescriptor, Fr = (i, t, e, s) => {
...
var hc = Object.defineProperty, dc = Object.getOwnPropertyDescriptor, wi = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? dc(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && hc(t, e, n), n;
};
const Ur = class extends k {
  constructor() {
...
let tn = Vr;
var pc = Object.defineProperty, fc = Object.getOwnPropertyDescriptor, gn = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? fc(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && pc(t, e, n), n;
};
const Wr = class extends k {
  constructor() {
...
gn([
  m({ type: Boolean, attribute: "labels-hidden", reflect: !0 })
], $i.prototype, "labelsHidden", 2);
gn([
  m({ type: Boolean, reflect: !0 })
], $i.prototype, "vertical", 1);
var mc = Object.defineProperty, bc = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && mc(t, e, n), n;
};
...
const gc = (i) => {
  const { components: t } = i, e = t.get(P.IfcLoader);
  return y`
    <bim-button
  ...
  const { components: t } = i, e = i.schemaTag ?? !0, s = i.viewDefinitionTag ?? !0, n = t.get(P.FragmentsManager), r = document.createElement("bim-table");
  r.addEventListener("cellcreated", ({ detail: a }) => {
    const { cell: l } = a;
    l.style.padding = "0.25rem 0";
  }), r.hiddenColumns = ["modelID"], r.headersHidden = !0;
  const o = [];
    ...
    Name: (a, l) => {
      ...
      return y`
       <div style="display: flex; flex: 1; gap: var(--bim-ui_size-4xs); justify-content: space-between; overflow: auto;">
        ...
        f.type = "file", f.accept = ".ifc", f.multiple = !1, f.addEventListener("change", async () => {
          if (!(f.files && f.files.length === 1))
            return;
          const b = f.files[0], g = await b.arrayBuffer(), C = await t.get(P.IfcPropertiesManager).saveToIfc(
            h,
            new Uint8Array(g)
          ...
          <bim-button @click=${(f) => {
        const b = t.get(P.Hider), g = f.target;
  ...
  if (t) {
    const { components: s } = i, n = s.get(P.FragmentsManager), [, r] = e;
...
async function Ke(i, t, e, s = Yr, n = !1) {
  const r = i.get(P.IfcRelationsIndexer), o = await t.getProperties(e);
  if (!o)
    return {
  ...
  for (const u in o) {
    const h = s.map((c) => typeof c == "string" ? u === c : c(u)).includes(!0);
    if (!(u === "type" || h))
      continue;
    const d = o[u];
    if (d)
...
const Sc = (i) => {
  const { components: t, classifications: e } = i, s = t.get(P.Classifier), n = (r) => {
    if (!r)
      return;
    const o = r;
    o.dataTransform = {
...
}, Symbol.toStringTag, { value: "Module" })), Tc = ["OwnerHistory", "ObjectPlacement", "CompositionType"], ls = async (i, t, e) => {
  const n = { ...{
  ...
  for (const s of t) {
    ...
    if (n.type === B.IFCELEMENTQUANTITY) {
  ...
  for (const s of t) {
    const n = await i.getProperties(s);
    if (n && n.type === B.IFCMATERIALLAYERSETUSAGE) {
  ...
  for (const r of t) {
    ...
    if (o && o.type === B.IFCCLASSIFICATIONREFERENCE) {
  ...
  var o;
  const e = i.get(P.IfcRelationsIndexer), s = i.get(P.FragmentsManager), n = [], r = [];
  for (const a in t) {
      ...
      for (const d of u) {
        ...
        if (_) {
          const b = _.filter(async (A) => {
            ...
            return E ? E.type === B.IFCPROPERTYSET : !1;
          }), g = await Ic(l, b);
          g.children && p.children.push(g);
          const $ = _.filter(async (A) => {
            const E = await l.getProperties(A);
            return E ? E.type === B.IFCELEMENTQUANTITY : !1;
          }), C = await Pc(l, $);
        ...
        if (w) {
          const b = w.filter(async (A) => {
            const E = await l.getProperties(A);
            return E ? E.type === B.IFCMATERIALLAYERSETUSAGE || E.type === B.IFCMATERIALLAYERSET || E.type === B.IFCMATERIALLAYER || E.type === B.IFCMATERIAL || E.type === B.IFCMATERIALLIST : !1;
          }), g = await Rc(l, b);
          g.children && p.children.push(g);
          const $ = w.filter(
            async (A) => {
              const E = await l.getProperties(A);
              return E ? E.type === B.IFCCLASSIFICATIONREFERENCE : !1;
            }
          ), C = await Nc(
            l,
            $
  ...
  return n;
}, Lc = new Event("datacomputed");
let pt;
const zc = (i) => {
  const { components: t, fragmentIdMap: e } = i;
  return pt || (pt = document.createElement("bim-table"), pt.columns = [{ name: "Name", width: "12rem" }], pt.headersHidden = !0, pt.addEventListener("cellcreated", ({ detail: s }) => {
    const { cell: n } = s;
...
}, Symbol.toStringTag, { value: "Module" })), en = async (i, t, e, s) => {
  var u;
  const n = [], r = i.get(P.IfcRelationsIndexer), o = await t.getProperties(e);
  if (!o)
    return n;
  const { type: a } = o, l = {
    data: {
      Entity: P.IfcCategoryMap[a],
  ...
  const n = i.get(P.IfcRelationsIndexer), r = [];
  for (const o of t) {
    let a;
    if (s)
      a = {
...
let st;
const cs = (i, t) => {
  const e = i.get(P.FragmentsManager), { modelID: s, expressID: n, relations: r } = t.data;
  if (!(s && n))
    return null;
  ...
  st || (st = document.createElement("bim-table"), st.hiddenColumns = ["modelID", "expressID", "relations"], st.columns = ["Entity", "Name"], st.headersHidden = !0, st.addEventListener("cellcreated", ({ detail: a }) => {
    const { cell: l } = a;
    l.column === "Entity" && !("Name" in l.rowData) && (l.style.gridColumn = "1 / -1");
  })), st.addEventListener("rowcreated", (a) => {
    a.stopImmediatePropagation();
    const { row: l } = a.detail, u = t.get(N.Highlighter);
    l.onmouseover = () => {
      if (!r)
        return;
      const h = cs(t, l);
  ...
  if (t) {
    const [, s] = e, { components: n } = i, r = n.get(P.FragmentsManager), o = n.get(P.IfcRelationsIndexer), a = () => s({ models: r.groups.values() });
  ...
  __proto__: null,
  relationsTree: Bc
}, Symbol.toStringTag, { value: "Module" })), fe = (i, t) => [...i.get(P.Grids).list.values()].find((n) => n.world === t), Vc = (i, t) => y`
    <bim-color-input @input=${(s) => {
  const n = s.target;
  i.color = new I.Color(n.color);
  ...
  return y`
    ...
    r.lineColor = new I.Color(l).getHex(), u && (r.opacity = u / 100);
  }} color=${e} opacity=${s * 100}></bim-color-input>
  `;
}, qc = (i, t) => y`
    <bim-color-input @input=${(s) => {
  const n = s.target, r = new I.Color(n.color);
  ...
  const { components: t } = i, e = t.get(P.Worlds);
  return y`<bim-table ${ot(async (n) => {
    ...
    r.preserveStructureOnFilter = !0, r.dataTransform = {
      Value: (c, p) => {
        ...
        if (b === "Near Frustum" && w.three instanceof I.PerspectiveCamera && typeof c == "number") {
          const g = w.three;
        ...
        if (b === "Far Frustum" && w.three instanceof I.PerspectiveCamera && typeof c == "number") {
          const g = w.three;
        ...
        if (b === "Field of View" && w.three instanceof I.PerspectiveCamera && typeof c == "number") {
          const g = w.three;
        ...
        if (b === "Intensity" && typeof c == "number") {
          if (p.Light && typeof p.Light == "string") {
            ...
            return g && g instanceof I.Light ? R(g, "intensity", c, {
              slider: !0,
              min: 0,
              max: 10,
              step: 0.1
          ...
          if (p.IsAOConfig && f instanceof N.PostproductionRenderer)
            return R(
        ...
        if (b === "Color" && typeof c == "string") {
          ...
          if ($ && $ instanceof I.Light)
            return Vc($, c);
          if (p.IsAOConfig && f instanceof N.PostproductionRenderer)
            return Wc(f, c);
        }
        if (b === "Ambient Oclussion" && typeof c == "boolean" && p.IsAOConfig && f instanceof N.PostproductionRenderer)
          return Yc(f, c);
        if (b === "Half Resolution" && p.IsAOConfig && f instanceof N.PostproductionRenderer && typeof c == "boolean")
          return ft(
            f.postproduction.n8ao.configuration,
            "halfRes",
            c
          );
        if (b === "Screen Space Radius" && p.IsAOConfig && f instanceof N.PostproductionRenderer && typeof c == "boolean")
          return ft(
            f.postproduction.n8ao.configuration,
            "screenSpaceRadius",
            c
          );
        if (b === "Radius" && p.IsAOConfig && f instanceof N.PostproductionRenderer && typeof c == "number")
          return R(
            f.postproduction.n8ao.configuration,
            "aoRadius",
            c,
        ...
        if (b === "Denoise Samples" && p.IsAOConfig && f instanceof N.PostproductionRenderer && typeof c == "number")
          return R(
            f.postproduction.n8ao.configuration,
            "denoiseSamples",
            c,
        ...
        if (b === "Samples" && p.IsAOConfig && f instanceof N.PostproductionRenderer && typeof c == "number")
          return R(
            f.postproduction.n8ao.configuration,
            "aoSamples",
            c,
        ...
        if (b === "Denoise Radius" && p.IsAOConfig && f instanceof N.PostproductionRenderer && typeof c == "number")
          return R(
            f.postproduction.n8ao.configuration,
            "denoiseRadius",
            c,
        ...
        if (b === "Distance Falloff" && p.IsAOConfig && f instanceof N.PostproductionRenderer && typeof c == "number")
          return R(
            f.postproduction.n8ao.configuration,
            "distanceFalloff",
            c,
        ...
        if (b === "Directional Light" && p.Light && typeof p.Light == "string" && typeof c == "boolean") {
          ...
          return g && g instanceof I.Light ? ft(g, "visible", c) : c;
        }
        ...
        return b === "Custom Effects" && p.IsCEConfig && f instanceof N.PostproductionRenderer && typeof c == "boolean" ? Jc(f, c) : b === "Color" && p.IsOutlineConfig && f instanceof N.PostproductionRenderer && typeof c == "string" ? Gc(f, c) : b === "Tolerance" && p.IsOutlineConfig && f instanceof N.PostproductionRenderer && typeof c == "number" ? R(
          f.postproduction.customEffects,
          "tolerance",
          c,
          { slider: !0, min: 0, max: 6, step: 0.01 }
        ) : b === "Outline" && p.IsOutlineConfig && f instanceof N.PostproductionRenderer && typeof c == "boolean" ? ft(
          f.postproduction.customEffects,
          "outlineEnabled",
          c
        ) : b === "Gloss" && p.IsGlossConfig && f instanceof N.PostproductionRenderer && typeof c == "boolean" ? ft(
          f.postproduction.customEffects,
          "glossEnabled",
          c
        ) : b === "Min" && p.IsGlossConfig && f instanceof N.PostproductionRenderer && typeof c == "number" ? R(
          f.postproduction.customEffects,
          "minGloss",
          c,
          { slider: !0, min: -0.5, max: 0.5, step: 0.01 }
        ) : b === "Max" && p.IsGlossConfig && f instanceof N.PostproductionRenderer && typeof c == "number" ? R(
          f.postproduction.customEffects,
          "maxGloss",
          c,
          { slider: !0, min: -0.5, max: 0.5, step: 0.01 }
        ) : b === "Exponent" && p.IsGlossConfig && f instanceof N.PostproductionRenderer && typeof c == "number" ? R(
          f.postproduction.customEffects,
          "glossExponent",
          c,
          { slider: !0, min: 0, max: 5, step: 0.01 }
        ) : b === "Gamma Correction" && p.IsGammaConfig && f instanceof N.PostproductionRenderer && typeof c == "boolean" ? Xc(f, c) : c;
      }
    ...
    for (const [, c] of e.list) {
      const { scene: p, camera: v, renderer: x } = c, _ = fe(t, c), w = {
        data: {
          Name: c instanceof P.SimpleWorld && c.name || c.uuid
        },
        children: []
      };
      if (p) {
      ...
      if (v.three instanceof I.PerspectiveCamera) {
        const f = {
          data: {
      ...
      if (x instanceof N.PostproductionRenderer) {
  ...
  if (t) {
    const [s] = e, n = () => e[1](), { components: r } = i, o = r.get(P.Worlds);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ze = globalThis, vn = Ze.ShadowRoot && (Ze.ShadyCSS === void 0 || Ze.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, yn = Symbol(), us = /* @__PURE__ */ new WeakMap();
let Jr = class {
  constructor(t, e, s) {
    if (this._$cssResult$ = !0, s !== yn)
      throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
const tu = (i) => new Jr(typeof i == "string" ? i : i + "", void 0, yn), Qr = (i, ...t) => {
  const e = i.length === 1 ? i[0] : t.reduce((s, n, r) => s + ((o) => {
    if (o._$cssResult$ === !0)
      return o.cssText;
    if (typeof o == "number")
...
}, hs = vn ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const s of t.cssRules)
    e += s.cssText;
  return tu(e);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: iu, defineProperty: nu, getOwnPropertyDescriptor: su, getOwnPropertyNames: ru, getOwnPropertySymbols: ou, getPrototypeOf: au } = Object, gt = globalThis, ds = gt.trustedTypes, lu = ds ? ds.emptyScript : "", Li = gt.reactiveElementPolyfillSupport, _e = (i, t) => i, ui = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? lu : null;
      break;
  ...
  return e;
} }, _n = (i, t) => !iu(i, t), ps = { attribute: !0, type: String, converter: ui, reflect: !1, hasChanged: _n };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const xe = globalThis, hi = xe.trustedTypes, fs = hi ? hi.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Kr = "$lit$", bt = `lit$${Math.random().toFixed(9).slice(2)}$`, Zr = "?" + bt, cu = `<${Zr}>`, zt = document, Oe = () => zt.createComment(""), Te = (i) => i === null || typeof i != "object" && typeof i != "function", to = Array.isArray, uu = (i) => to(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", zi = `[ 	
\f\r]`, me = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ms = /-->/g, bs = />/g, It = RegExp(`>|${zi}(?:([^\\s"'>=/]+)(${zi}*=${zi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), gs = /'/g, vs = /"/g, eo = /^(?:script|style|textarea|title)$/i, hu = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), io = hu(1), te = Symbol.for("lit-noChange"), z = Symbol.for("lit-nothing"), ys = /* @__PURE__ */ new WeakMap(), Rt = zt.createTreeWalker(zt, 129);
function no(i, t) {
  if (!Array.isArray(i) || !i.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
...
class Ie {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = Ie.createElement(u, s), Rt.currentNode = this.el.content, e === 2) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
        ...
        if (n.hasAttributes())
          for (const d of n.getAttributeNames())
            if (d.endsWith(Kr)) {
              ...
              l.push({ type: 1, index: r, name: v[2], strings: p, ctor: v[1] === "." ? fu : v[1] === "?" ? mu : v[1] === "@" ? bu : Ci }), n.removeAttribute(d);
            } else
...
function ee(i, t, e = i, s) {
  ...
  return (n == null ? void 0 : n.constructor) !== r && ((a = n == null ? void 0 : n._$AO) == null || a.call(n, !1), r === void 0 ? n = void 0 : (n = new r(i), n._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = n : e._$Cl = n), n !== void 0 && (t = ee(i, n._$AS(i, t.values), n, s)), t;
}
class pu {
  constructor(t, e) {
    this._$AV = [], this._$AN = void 0, this._$AD = t, this._$AM = e;
  ...
  u(t) {
    const { el: { content: e }, parts: s } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? zt).importNode(e, !0);
    Rt.currentNode = n;
...
class We {
  ...
  constructor(t, e, s, n) {
    this.type = 2, this._$AH = z, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = s, this.options = n, this._$Cv = (n == null ? void 0 : n.isConnected) ?? !0;
  }
  get parentNode() {
    let t = this._$AA.parentNode;
    const e = this._$AM;
  ...
  k(t) {
    ...
    let s, n = 0;
    for (const r of t)
      n === e.length ? e.push(s = new We(this.S(Oe()), this.S(Oe()), this, this.options)) : s = e[n], s._$AI(r), n++;
    n < e.length && (this._$AR(s && s._$AB.nextSibling, n), e.length = n);
  }
  _$AR(t = this._$AA.nextSibling, e) {
    var s;
...
const Di = xe.litHtmlPolyfillSupport;
...
var _s;
Gt._$litElement$ = !0, Gt.finalized = !0, (_s = globalThis.litElementHydrateSupport) == null || _s.call(globalThis, { LitElement: Gt });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const yu = { attribute: !0, type: String, converter: ui, reflect: !1, hasChanged: _n }, _u = (i = yu, t, e) => {
  const { kind: s, metadata: n } = e;
  let r = globalThis.litPropertyMetadata.get(n);
  if (r === void 0 && globalThis.litPropertyMetadata.set(n, r = /* @__PURE__ */ new Map()), r.set(e.name, i), s === "accessor") {
    const { name: o } = e;
...
class wu extends uo {
  constructor(t = document.createElement("div")) {
    super(), this.isCSS2DObject = !0, this.element = t, this.element.style.position = "absolute", this.element.style.userSelect = "none", this.element.setAttribute("draggable", !1), this.center = new ho(0.5, 0.5), this.addEventListener("removed", function() {
...
class $u {
  ...
  regenerate() {
    ...
    let Ai = Math.ceil(so / b) * b;
    for (let F = 0; F < C; F++) {
      let L = Q + F * b;
      U.push(L, a, 0, L, o, 0), L = Math.round(L * H) / H, Ai = Math.round(Ai * H) / H;
      const de = L % Ai;
    ...
    const ro = new I.BufferAttribute(new Float32Array(U), 3), oo = new I.BufferAttribute(new Float32Array(Si), 3), { main: ao, secondary: lo } = this.grids;
  ...
  newGrid(t) {
    const e = new I.BufferGeometry(), s = new I.LineSegments(e, this.material);
...
var Cu = Object.defineProperty, Eu = Object.getOwnPropertyDescriptor, Ge = (i, t, e, s) => {
  for (var n = Eu(t, e), r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Cu(t, e, n), n;
};
const xn = class xn extends Gt {
  constructor() {
  ...
  set components(t) {
    this.dispose();
    const s = t.get(P.Worlds).create();
    this._world = s, s.scene = new P.SimpleScene(t), s.scene.setup(), s.renderer = new N.RendererWith2D(t, this);
    const n = new P.OrthoPerspectiveCamera(t);
    s.camera = n;
...
let xt = xn;
Ge([
  G({ type: String, attribute: "grid-color", reflect: !0 })
], xt.prototype, "gridColor");
Ge([
  G({ type: Number, attribute: "grid-scale-x", reflect: !0 })
], xt.prototype, "gridScaleX");
Ge([
  G({ type: Number, attribute: "grid-scale-y", reflect: !0 })
], xt.prototype, "gridScaleY");
Ge([
  G({ type: Number, attribute: "grid-offset-x", reflect: !0 })
], xt.prototype, "gridOffsetX");
Ge([
  G({ type: Number, attribute: "grid-offset-y", reflect: !0 })
], xt.prototype, "gridOffsetY");
var Au = Object.defineProperty, St = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Au(t, e, n), n;
};
const wn = class wn extends Gt {
  constructor() {
...
St([
  G({ type: String, attribute: "right-text", reflect: !0 })
], Z.prototype, "rightText");
St([
  G({ type: String, attribute: "left-text", reflect: !0 })
], Z.prototype, "leftText");
St([
  G({ type: String, attribute: "top-text", reflect: !0 })
], Z.prototype, "topText");
St([
  G({ type: String, attribute: "bottom-text", reflect: !0 })
], Z.prototype, "bottomText");
St([
  G({ type: String, attribute: "front-text", reflect: !0 })
], Z.prototype, "frontText");
St([
  G({ type: String, attribute: "back-text", reflect: !0 })
