...
export interface TableRowTemplate {
    [columnName: string]: string | number | boolean | HTMLElement | TemplateResult;
}
/**
...
export interface TableDataTransform {
    [columnName: string]: (value: string | number | boolean, data: TableRowData) => string | number | boolean | HTMLElement | TemplateResult;
}
/**
