...
const It = Math.min, W = Math.max, xe = Math.round, st = (i) => ({
  x: i,
  y: i
}), Hs = {
  left: "right",
...
function sr(i) {
  ...
  const r = n === "fixed", o = pt(s), a = t ? Qn(t.floating) : !1;
  if (s === o || a && r)
    return e;
  let l = {
    scrollLeft: 0,
...
function ar(i, t) {
  const e = Kt(i, !0, t === "fixed"), s = e.top + i.clientTop, n = e.left + i.clientLeft, r = U(i) ? Pt(i) : st(1), o = i.clientWidth * r.x, a = i.clientHeight * r.y, l = n * r.x, c = s * r.y;
  return {
    width: o,
    height: a,
    x: l,
...
function cr(i, t) {
  ...
  if (e)
    return e;
  let s = ni(i, [], !1).filter((a) => Y(a) && rt(a) !== "body"), n = null;
...
function dr(i, t, e) {
  const s = U(t), n = pt(t), r = e === "fixed", o = Kt(i, !0, r, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: vr, defineProperty: yr, getOwnPropertyDescriptor: _r, getOwnPropertyNames: wr, getOwnPropertySymbols: xr, getPrototypeOf: $r } = Object, nt = globalThis, ln = nt.trustedTypes, Cr = ln ? ln.emptyScript : "", Qe = nt.reactiveElementPolyfillSupport, Qt = (i, t) => i, Ce = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Cr : null;
      break;
  ...
  return e;
} }, wi = (i, t) => !vr(i, t), an = { attribute: !0, type: String, converter: Ce, reflect: !1, hasChanged: wi };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Yt = globalThis, Ee = Yt.trustedTypes, cn = Ee ? Ee.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, is = "$lit$", it = `lit$${Math.random().toFixed(9).slice(2)}$`, ns = "?" + it, Er = `<${ns}>`, xt = document, Zt = () => xt.createComment(""), te = (i) => i === null || typeof i != "object" && typeof i != "function", ss = Array.isArray, Sr = (i) => ss(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Ye = `[ 	
\f\r]`, qt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, un = /-->/g, hn = />/g, vt = RegExp(`>|${Ye}(?:([^\\s"'>=/]+)(${Ye}*=${Ye}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), dn = /'/g, fn = /"/g, rs = /^(?:script|style|textarea|title)$/i, Ar = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), m = Ar(1), $t = Symbol.for("lit-noChange"), k = Symbol.for("lit-nothing"), pn = /* @__PURE__ */ new WeakMap(), yt = xt.createTreeWalker(xt, 129);
function os(i, t) {
...
class ee {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = ee.createElement(c, s), yt.currentNode = this.el.content, e === 2) {
...
class kr {
  ...
  u(t) {
    const { el: { content: e }, parts: s } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? xt).importNode(e, !0);
    yt.currentNode = n;
...
var Rn;
x._$litElement$ = !0, x.finalized = !0, (Rn = globalThis.litElementHydrateSupport) == null || Rn.call(globalThis, { LitElement: x });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const zr = { attribute: !0, type: String, converter: Ce, reflect: !1, hasChanged: wi }, Rr = (i = zr, t, e) => {
...
const Je = /* @__PURE__ */ new WeakMap(), Lt = as(class extends Nr {
  render(i) {
    return k;
  }
  update(i, [t]) {
...
const xn = "iconify2", se = "iconify", ws = se + "-count", $n = se + "-version", xs = 36e5, uo = 168, ho = 50;
function li(i, t) {
  try {
    return i.getItem(t);
  } catch {
...
const xo = /(-?[0-9.]*[0-9]+[0-9.]*)/g, $o = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function ui(i, t, e) {
  if (t === 1)
    return i;
...
const Ao = (i) => i === "unset" || i === "undefined" || i === "none";
function Os(i, t) {
  const e = {
    ...ue,
    ...i
...
function Ts() {
  ...
  return {
    enableCache: (e) => Sn(e, !0),
    disableCache: (e) => Sn(e, !1),
    iconLoaded: vn,
    iconExists: vn,
    getIcon: to,
    listIcons: Zr,
...
const D = (Nt = class extends x {
  constructor() {
    super(), this.labelHidden = !1, this.active = !1, this.disabled = !1, this.vertical = !1, this.tooltipVisible = !1, this._parent = Tt(), this._tooltip = Tt(), this._contextMenu = Tt(), this._mouseLeave = !1, this.onWindowMouseUp = (t) => {
...
var Yo = Object.defineProperty, Dt = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Yo(t, e, n), n;
};
const Pi = class Pi extends x {
  constructor() {
    super(...arguments), this.vertical = !1, this.color = "#bcf124", this._colorInput = Tt(), this._textInput = Tt(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
      const e = t.target;
...
var Jo = Object.defineProperty, Ko = Object.getOwnPropertyDescriptor, Zo = (i, t, e, s) => {
  for (var n = Ko(t, e), r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Jo(t, e, n), n;
};
const Ti = class Ti extends x {
  constructor() {
...
const Te = (i, t = !0) => {
  ...
  return e;
}, Ve = (i) => i === "true" || i === "false" ? i === "true" : i && !isNaN(Number(i)) && i.trim() !== "" ? Number(i) : i, el = [">=", "<=", "=", ">", "<", "?", "/", "#"];
function In(i) {
  const t = el.find(
...
var il = Object.defineProperty, nl = Object.getOwnPropertyDescriptor, mt = (i, t, e, s) => {
...
var sl = Object.defineProperty, rl = Object.getOwnPropertyDescriptor, bt = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? rl(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && sl(t, e, n), n;
};
const Ii = class Ii extends tl {
  constructor() {
...
var ol = Object.defineProperty, Is = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && ol(t, e, n), n;
};
...
let pi = Me;
var ll = Object.defineProperty, Ue = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && ll(t, e, n), n;
};
const Ri = class Ri extends x {
  constructor() {
...
var al = Object.defineProperty, fe = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && al(t, e, n), n;
};
...
var cl = Object.defineProperty, ul = Object.getOwnPropertyDescriptor, M = (i, t, e, s) => {
...
const ji = class ji extends x {
  constructor() {
    super(...arguments), this._value = 0, this.vertical = !1, this.slider = !1, this._input = Tt(), this.onValueChange = new Event("change");
  }
  set value(t) {
...
var hl = Object.defineProperty, dl = Object.getOwnPropertyDescriptor, pe = (i, t, e, s) => {
...
var pl = Object.defineProperty, be = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && pl(t, e, n), n;
};
...
var ml = Object.defineProperty, bl = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && ml(t, e, n), n;
};
...
var gl = Object.defineProperty, vl = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && gl(t, e, n), n;
};
...
var yl = Object.defineProperty, _l = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && yl(t, e, n), n;
};
...
var wl = Object.defineProperty, ge = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && wl(t, e, n), n;
};
...
var xl = Object.defineProperty, $l = Object.getOwnPropertyDescriptor, Ft = (i, t, e, s) => {
...
var Cl = Object.defineProperty, El = Object.getOwnPropertyDescriptor, qe = (i, t, e, s) => {
...
var Sl = Object.defineProperty, Al = Object.getOwnPropertyDescriptor, Vt = (i, t, e, s) => {
 ...
 */
const Ol = (i) => i ?? k;
var kl = Object.defineProperty, Pl = Object.getOwnPropertyDescriptor, gt = (i, t, e, s) => {
...
var Tl = Object.defineProperty, Ll = Object.getOwnPropertyDescriptor, zs = (i, t, e, s) => {
...
var Il = Object.defineProperty, zl = Object.getOwnPropertyDescriptor, We = (i, t, e, s) => {
...
const y = class y {
   ...
   */
  static init() {
    y.addGlobalStyles(), y.defineCustomElement("bim-button", Wo), y.defineCustomElement("bim-checkbox", lt), y.defineCustomElement("bim-color-input", G), y.defineCustomElement("bim-context-menu", Pe), y.defineCustomElement("bim-dropdown", H), y.defineCustomElement("bim-grid", re), y.defineCustomElement("bim-icon", pi), y.defineCustomElement("bim-input", Ct), y.defineCustomElement("bim-label", at), y.defineCustomElement("bim-number-input", L), y.defineCustomElement("bim-option", P), y.defineCustomElement("bim-panel", ct), y.defineCustomElement("bim-panel-section", ut), y.defineCustomElement("bim-selector", ht), y.defineCustomElement("bim-table", X), y.defineCustomElement("bim-tabs", J), y.defineCustomElement("bim-tab", I), y.defineCustomElement("bim-table-cell", Le), y.defineCustomElement("bim-table-children", Ie), y.defineCustomElement("bim-table-group", ze), y.defineCustomElement("bim-table-row", dt), y.defineCustomElement("bim-text-input", N), y.defineCustomElement("bim-toolbar", Ht), y.defineCustomElement("bim-toolbar-group", Bt), y.defineCustomElement(
      "bim-toolbar-section",
      ft
    ), y.defineCustomElement("bim-viewport", Re);
  }
  static newRandomId() {
...
let mi = y;
var Rl = Object.defineProperty, Ml = Object.getOwnPropertyDescriptor, Oi = (i, t, e, s) => {
...
var jl = Object.defineProperty, Bl = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && jl(t, e, n), n;
};
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Rs = "important", Hl = " !" + Rs, Ul = as(class extends cs {
  constructor(i) {
    var t;
